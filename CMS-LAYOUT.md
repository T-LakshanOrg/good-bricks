...
2. In Railway, open the CMS service. Press Cmd + K, type "deploy latest commit", and press Enter. Auto deploy is switched off on purpose, so nothing goes live until you do this.
